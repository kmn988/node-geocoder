 ...
 * Constructor
 */
var OpenStreetMapGeocoder = function OpenStreetMapGeocoder(
  httpAdapter,
  options
) {
  ...
  var osmServer =
    (options && options.osmServer) || 'http://nominatim.openstreetmap.org';
...
OpenStreetMapGeocoder.prototype._endpoint =
  'https://nominatim.openstreetmap.org/search';

OpenStreetMapGeocoder.prototype._endpoint_reverse =
...
OpenStreetMapGeocoder.prototype._formatResult = function (result) {
  ...
  if (result.address) {
    ...
    streetName =
      result.address.street || result.address.cycleway || result.address.road;
